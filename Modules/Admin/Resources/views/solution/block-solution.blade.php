...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::solution.index.danh_sach_block_giai_phap') {{$title}}</h3>
                ...
                <div class="tab-pane active" id="kt_widget3_tab1_content">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h3>@lang('admin::solution.index.block_content')</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h3>@lang('admin::solution.index.block_item')</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-2">
{{--                                <a href="{{route('admin.map',['page_id' => $page_id, 'page_type' => $page_type ])}}" class="btn btn-primary">@lang('admin::solution.index.cau_hinh')</a>--}}
                                @include('helpers.button', ['button' => [
                                  'route' => 'admin.map',
                            ...
                            <div class="col-10">
                                <h3>@lang('admin::solution.index.block_product')</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <h3>@lang('admin::solution.index.block_footer')</h3>
                            </div>
                        </div>
                    </div>
                    <!--End::Timeline 3 -->
