...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::solution.index.danh_sach_danh_muc_giai_phap')</h3>
    ...
    <!--begin: Datatable -->
    <form id="form-filter" action="{{route('admin.solution.category')}}">
            ...
            <div class="kt-portlet__body">
                <div class="row">
                    ...
                    <div class="form-group col-2 text-right">
                        ...
                        <a href="{{route('admin.solution.category')}}">
                            <button type="button"
                ...
                <div class="form-group">
                    <div class="kt-section__content">
                        <table class="table table-striped table-store">
                            <thead>
                            <tr>
                                <th width="40%">@lang('admin::solution.index.tieu_de_tieng_viet')</th>
                                <th width="40%">@lang('admin::solution.index.tieu_de_tieng_anh')</th>
                                <th width="20%"></th>
                            </tr>
                            </thead>
                            <tbody>
