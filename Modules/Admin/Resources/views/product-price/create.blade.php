...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::product-price.index.tao_trang')</h3>
        ...
        <div class="kt-subheader__toolbar">
            <button type="button" class="form-control btn btn-primary" onclick="productprice.create()">@lang('admin::product-price.index.tao')</button>
    ...
    <!--begin: Datatable -->
    <form id="create-product-price" class="kt-form" method="POST">
                    ...
                    <div class="tab-pane active" id="kt_widget3_tab1_content">
                            ...
                            <div class="tab-pane active" id="page_title_vi_tab" role="tabpanel">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" class="form-control" name="name_vi" placeholder="@lang('admin::product-price.index.ten_tieng_viet')">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <div>
                                                <textarea class="summernote form-control" name="description_vi" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="page_title_en_tab" role="tabpanel">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" class="form-control" name="name_en" placeholder="@lang('admin::product-price.index.ten_tieng_anh')">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <div>
                                                <textarea class="summernote form-control" name="description_en" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="price" placeholder="@lang('admin::product-price.index.gia')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="text" name="price_order" class="form-control">
                                </div>
                            </div>
                        </div>
        ...
        <input type="text" hidden name="page_id" value="{{$page_id}}">
    </form>
@endsection
