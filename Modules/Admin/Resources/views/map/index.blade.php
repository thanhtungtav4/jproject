...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        @if ($filter['plugin_type'] != "about-home-list" and $filter['plugin_type'] != "solution-list" )
                ...
                <div class="row">
                    <div class="form-group col-5">
                        <input  class="form-control d-inline"
                                ...
                                value="{{isset($filter['keyword_plugin_title_vi'])
                                    ? $filter['keyword_plugin_title_vi'] : ""}}"
                    ...
                    <div class="form-group col-5">
                        ...
                        <input  class="form-control d-inline"
                                ...
                                value="{{isset($filter['keyword_plugin_title_en'])
                                    ? $filter['keyword_plugin_title_en'] : ""}}"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @foreach($map_page as $value)
                                                @if(
                                                    $value['plugin_id'] == $item['plugin_id']
...
{{--                                                        ('{{$page_id}}','{{$item['plugin_id']}}','{{$type}}')">--}}
                                            ...
                                            @else
                                                <button
                                                    type="button"
{{--                                                    class="form-control btn btn-primary" onclick="popup.add('{{$page_id}}','{{$item['plugin_id']}}','{{$type}}')">--}}
