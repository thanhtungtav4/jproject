...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::agency.index.TITLE_AGENCY')</h3>
        ...
        <div class="kt-subheader__toolbar">
            <a href="{{route('admin.agency.create')}}" class="btn btn-label-brand btn-bold">
                @lang('admin::agency.index.CREATE_AGENCY')
            </a>
        </div>
    </div>
    <!--begin: Datatable -->
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        <div class="kt-portlet kt-portlet--tabs">
            <div class="kt-portlet__body">
                <form id="form-filter" action="{{route('admin.agency')}}">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            <a class="btn btn-secondary" href="{{route('admin.agency')}}">
