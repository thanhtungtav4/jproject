            ...
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc text-capitalize" id="kt_subheader_total">
                                         @lang('admin::agency.edit.UPDATE_AGENCY')
                                    </span>
                </div>
            </div>
            <div class="kt-subheader__toolbar">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-primary" onclick="update.submit({{$item['id']}})">
                        @lang('admin::agency.edit.SAVE')
                    </button>
                    <a href="{{route('admin.agency')}}" class="btn btn-secondary">
                        @lang('admin::agency.edit.CANCEL')
                    </a>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::agency.edit.NAME_VI')
                                                <span class="color_red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input type="text" class="form-control"
                                                       id="name_vi" name="name_vi" value="{{$item['name_vi']}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::agency.edit.NAME_EN')
                                                <span class="color_red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input type="text" class="form-control"
                                                       id="name_en" name="name_en" value="{{$item['name_en']}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar">
                                                    <div id="div-image">
                                                        @if(isset($item['image_logo']))
                                                            <div class="kt-avatar__holder"
                                                                 style="background-image: url({{asset($item['image_logo'])}});background-position: center;"></div>
                                                        @else
                                                            <div class="kt-avatar__holder"
