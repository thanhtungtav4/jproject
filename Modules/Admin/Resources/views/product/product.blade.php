...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::product.index.danh_sach_san_pham')</h3>
        ...
        <div class="kt-subheader__toolbar">
            @include('helpers.button', ['button' => [
                ...
                'html' => '<a href="'.route('admin.product.category').'" class="btn btn-label-brand btn-bold">'
    ...
    <!--begin: Datatable -->
    <form id="form-filter" action="{{route('admin.product.product')}}">
...
{{--                        </label>--}}
                        <input  class="form-control d-inline"
                                ...
                                placeholder="@lang('admin::product.index.danh_muc_tieng_viet')">
                    </div>
                    <div class="form-group col-sm-3 col-6">
{{--                        <label class="col-form-label padding-right w-20">--}}
{{--                            Danh mục tiếng anh--}}
{{--                        </label>--}}
                        <input  class="form-control d-inline"
                                ...
                                placeholder="@lang('admin::product.index.danh_muc_tieng_anh')">
                    </div>
                    <div class="form-group col-sm-3 col-6">
{{--                        <label class="col-form-label padding-right w-20">--}}
{{--                            Tên tiếng việt--}}
                ...
                <div class="form-group">
                    <div class="kt-section__content">
                        <table class="table table-striped table-store">
                            ...
                            <tr>
                                <th width="10%"></th>
                                <th width="20%">@lang('admin::product.index.danh_muc_tieng_viet')</th>
                                <th width="20%">@lang('admin::product.index.danh_muc_tieng_anh')</th>
                                <th width="20%">@lang('admin::product.index.ten_tieng_viet')</th>
                                <th width="20%">@lang('admin::product.index.ten_tieng_anh')</th>
                                <th width="10%"></th>
                            </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        @include('helpers.button', ['button' => [
                                           ...
                                           'html' => '<a href="'.route('admin.product.product.block',['page_alias_vi' => $item['page_alias_vi']]).'" class="btn btn-label-brand btn-bold">'
                                           .'Cấu hình'.
                                       '</a>'
                                       ]])
                                    </td>
