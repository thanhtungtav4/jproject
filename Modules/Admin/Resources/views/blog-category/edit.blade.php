            ...
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc text-capitalize" id="kt_subheader_total">
                                         @lang('admin::blog-category.edit.UPDATE_LOG_CATEGORY')
                                    </span>
                </div>
            </div>
            <div class="kt-subheader__toolbar">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-primary" onclick="update.submit({{$item['id']}})">
                        @lang('admin::blog-category.edit.SAVE')
                    </button>
                    <a href="{{route('admin.blog-category')}}" class="btn btn-secondary">
                        @lang('admin::blog-category.edit.CANCEL')
                    </a>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::blog-category.edit.TITLE_VN')
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::blog-category.edit.TITLE_EN')
                                                <span class="color_red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input type="text" class="form-control"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::blog-category.edit.IMAGE')
                                                <span class="color_red">*</span></label>
                                            </label>
                                            <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::blog-category.edit.CONTENT_VN')
                                                <span class="color_red">*</span></label>
                                            </label>
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="summernote">
                                                    <textarea name="content_vi"
                                                              id="content_vi">{{$item['content_vi']}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::blog-category.edit.CONTENT_EN')
                                                <span class="color_red">*</span></label>
                                            </label>
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="summernote">
                                                    <textarea name="content_en"
                                                              id="content_en">{{$item['content_en']}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
