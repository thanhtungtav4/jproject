...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::category.index.chinh_sua_danh_muc')</h3>
        ...
        <div class="kt-subheader__toolbar">
            <button type="button" class="form-control btn btn-primary" onclick="category.update()">@lang('admin::category.index.luu')</button>
    ...
    <!--begin: Datatable -->
    <form id="edit-category" class="kt-form" method="POST">
                    ...
                    <div class="tab-pane active" id="kt_widget3_tab1_content">
                            ...
                            <div class="tab-pane active" id="name_vi" role="tabpanel">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" class="form-control" name="name_vi" placeholder="@lang('admin::category.index.ten_tieng_viet')" value="{{$category['name_vi']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="name_en" role="tabpanel">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input type="text" class="form-control" name="name_en" placeholder="@lang('admin::category.index.ten_tieng_anh')" value="{{$category['name_en']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="ordering" placeholder="@lang('admin::category.index.vi_tri')" value="{{$category['ordering']}}">
                                </div>
                            </div>
                        </div>
