...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::blog.index.TITLE_LOG')</h3>
        ...
        <div class="kt-subheader__toolbar">
            @include('helpers.button', ['button' => [
                ...
                'html' => '<a href="'.route('admin.blog.create').'" class="btn btn-label-brand btn-bold">'
                .__('admin::blog.index.CREATE_LOG').
            '</a>'
            ]])
        </div>
    </div>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        <div class="kt-portlet kt-portlet--tabs">
            <div class="kt-portlet__body">
                <form id="form-filter" action="{{route('admin.blog')}}">
{{--                    <div class="row">--}}
...
{{--                                @lang('admin::blog.index.RESET')--}}
{{--                            </a>--}}
{{--                            <button type="submit"--}}
{{--                                    class="btn btn-primary btn-hover-brand">--}}
{{--                                @lang('admin::blog.index.SEARCH')--}}
{{--                            </button>--}}
{{--                        </div>--}}
{{--                    </div>--}}
