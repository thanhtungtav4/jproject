            ...
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc text-capitalize" id="kt_subheader_total">
                                         @lang('admin::blog.create.CREATE_LOG')
                                    </span>
                </div>
            </div>
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <select class="form-control" id="category_id" name="category_id">
                                                    ...
                                                    @if(isset($optionBlogCategory))
                                                        @foreach($optionBlogCategory as $item)
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="kt-radio-list">
                                                    <label class="kt-radio kt-radio--solid kt-radio--success">
                                                        <input type="radio" name="news_status" checked value="new"> New
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid kt-radio--success">
                                                        <input type="radio" name="news_status" value="review"> Review
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid kt-radio--success">
                                                    ...
                                                    <label class="kt-radio kt-radio--solid kt-radio--success">
                                                        <input type="radio" name="news_status" value="reject"> Reject
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
