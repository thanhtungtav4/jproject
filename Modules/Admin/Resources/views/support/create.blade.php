            ...
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
                                    <span class="kt-subheader__desc text-capitalize" id="kt_subheader_total">
                                         @lang('admin::support.create.CREATE_SUPPORT')
                                    </span>
                </div>
            </div>
            <div class="kt-subheader__toolbar">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-primary" onclick="create.submit_load()">
                        @lang('admin::support.create.SAVE_NEW')
                    </button>
                    <button type="button" class="btn btn-primary" onclick="create.submit_close()">
                        @lang('admin::support.create.SAVE_CLOSE')
                    </button>
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::support.create.TITLE_VN')
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::support.create.TITLE_EN')
                                                <span class="color_red">*</span></label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input type="text" class="form-control"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::support.create.DESCRIPTION_VN')
                                            </label>
                                            <div class="col-lg-9 col-xl-9">
                                                <textarea type="text" class="form-control"
                                                          id="description_vi" name="description_vi" cols="5">
                                                </textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::support.create.DESCRIPTION_EN')
                                            </label>
                                            <div class="col-lg-9 col-xl-9">
                                                <textarea type="text" class="form-control"
                                                          id="description_en" name="description_en" cols="5">
                                                </textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::support.create.IMAGE')
                                                <span class="color_red">*</span></label>
                                            </label>
                                            <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::support.create.CONTENT_VN')
                                                <span class="color_red">*</span></label>
                                            </label>
                                            <div class="col-lg-9 col-xl-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                @lang('admin::support.create.CONTENT_EN')
                                                <span class="color_red">*</span></label>
                                            </label>
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="summernote">
