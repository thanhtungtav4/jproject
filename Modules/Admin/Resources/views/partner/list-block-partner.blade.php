...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('admin::partner.index.danh_sach_block_doi_tac') {{$titlePage}}</h3>
            ...
            <div class="kt-portlet__body">
                <div class="tab-pane active" id="kt_widget3_tab1_content">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-2">
                                <a href="{{route('admin.map',['page_id' => $page_id, 'plugin_type' => 'content-box'])}}" class="btn btn-label-brand btn-bold">@lang('admin::partner.index.cau_hinh')</a>
                            </div>
                            <div class="col-10">
                                <h3>@lang('admin::partner.index.block_content')</h3>
                            </div>
                        </div>
                    </div>
...
{{--                            </div>--}}
{{--                            <div class="col-10">--}}
{{--                                <h3>Dịch vụ đa dạng và luôn mở rộng</h3>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                            </div>--}}
{{--                            <div class="col-10">--}}
{{--                                <h3>Một "cái bắt tay lớn" giữa Tpcoms và VMware</h3>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    <!--End::Timeline 3 -->
